...
- **[python](./python)**: Foundations of Python programming.
  ...
  - [10_python_oop_part3.ipynb](./python/10_python_oop_part3.ipynb): Aggregation, inheritance types, MRO, and polymorphism.
  - [11_python_abstraction.ipynb](./python/11_python_abstraction.ipynb): Abstract classes and enforcing implementations.
